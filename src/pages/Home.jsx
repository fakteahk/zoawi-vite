...
function Home() {
  return (
    <>
      <div className="w-[90%] md:w-[70%] bg-neutral-100 h-64 shadow-md flex flex-col items-center justify-center mx-auto mb-12 rounded-xl ">
        ...
        <div className="text-xl font-extralight">database in Mizoram. No cap.</div>
      </div>
