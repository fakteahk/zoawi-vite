                ...
                <div className="mt-2">
                  <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-secondary/50 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                    <input
                      ...
                      id="title"
                      autoComplete="title"
                      className="block flex-1 border-0 bg-transparent placeholder:font-thin py-1.5 pl-2 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm: sm:leading-6"
                  ...
                  {errors?.title?.message && (
                    <div className="font-thin text-xs p-2">
                      {errors.title.message}
                    </div>
                  )}
                </div>
